 ...
 *
 */
public class BoxWithMultiDimensionalPrimitiveArray implements Shape, Size, Persistable {
	...
	public BoxWithMultiDimensionalPrimitiveArray() {
		width = 10;
	 ...
	 * @param height
	 */
	public BoxWithMultiDimensionalPrimitiveArray(int width, int length, int height) {
		this.width = width;
		this.length = length;
		this.height = height;
	}

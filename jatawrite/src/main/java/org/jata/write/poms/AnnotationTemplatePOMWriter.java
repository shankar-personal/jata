...
public class AnnotationTemplatePOMWriter {

	public static void write(Class clazz, String dirName, String idString) throws IOException {
		write(clazz, dirName, idString, null);
	}

	public static String getAnnotationTemplateProjectName( String idString) {
		return idString +"-annotation" ;
	}

	public static void write(Class clazz, String dirName, String idString, String version) throws IOException {
		String outputFileName = dirName + File.separator + AnnotationTemplateWriter.ANNOTATIONS_BASE_DIR + File.separator +  "pom.xml";
		...
		try {
			...
			writer.write("   <artifactId>" + getAnnotationTemplateProjectName(idString)+ "</artifactId>\n");
			writer.write("   <version> " + version+ "</version>\n");
			writer.write("   <description></description>\n");
			writer.write("   <parent>\n");
			writer.write("            <groupId> " + packageName
					+ " </groupId>\n");
			writer.write("            <artifactId>" + idString
					+ "</artifactId>\n");
			writer.write("            <version>"
					+ JataWriter.JATA_WRITER_VERSION + "</version>\n");
			writer.write("   </parent>\n");
			...
			writer.write("        <dependency>\n");
			writer.write("            <groupId>" +packageName + "</groupId>\n");
			writer.write("            <artifactId>" + ValidationPOMWriter.getValidationProjectName(idString) + "</artifactId>\n");
			writer.write("            <version>" + version+"</version>\n");
			writer.write("        </dependency>\n");
			writer.write("   </dependencies>\n");
			writer.write("   <build>\n");
			...
			writer.write("         </resource>\n");
			writer.write("         <resource>\n");
			writer.write("           <directory>${basedir}/src/main/resources</directory>\n");
			writer.write("         </resource>\n");
			writer.write("       </resources>\n");

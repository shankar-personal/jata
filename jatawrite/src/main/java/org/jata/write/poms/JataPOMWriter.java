...
public class JataPOMWriter {
	...
	public static String getJataProjectName( String idString) {
		return idString +"-jata" ;
	}

	public static void write(Object object, String dirName, String idString, String version) throws IOException {
		String outputFileName = dirName + File.separator + JataWriter.JATA_BASE_DIR + File.separator + "pom.xml";
		...
		try {
			...
			writer.write("   <artifactId>" + getJataProjectName(idString)
					+ "</artifactId>\n");
			...
			writer.write("            <groupId> " + packageName
					+ " </groupId>\n");
			writer.write("            <artifactId>" + idString + "-validation"
					+ "</artifactId>\n");
			writer.write("            <version>"
					+ JataWriter.JATA_WRITER_VERSION + "</version>\n");
			writer.write("        </dependency>\n");
			...
			writer.write("            <plugin>\n");
			writer
					.write("                <groupId>org.apache.maven.plugins</groupId>\n");
			writer
					.write("                <artifactId>maven-compiler-plugin</artifactId>\n");
